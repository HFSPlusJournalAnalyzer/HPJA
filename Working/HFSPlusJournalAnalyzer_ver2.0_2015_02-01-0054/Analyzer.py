...
def journalBufferParser(journalBuffer,endian,base,size,blhdr_size):
...
def journalParser(journal):
    ...
    endian=unpack_from('>L',journal,4)
    magic,temp1,start,end,size,blhdr_size,jhdr_size=unpack(endian+'LLQQQLL',journal)
    
    return JournalBufferParser(journal[jhdr_size:size],endian,end,size-jhdr_size,blhdr_size)
